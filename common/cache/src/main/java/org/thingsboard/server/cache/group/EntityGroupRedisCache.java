 ...
 */
package org.thingsboard.server.cache.group;
...
public class EntityGroupRedisCache extends RedisTbTransactionalCache<EntityGroupCacheKey, EntityGroup> {
    ...
    public EntityGroupRedisCache(TBRedisCacheConfiguration configuration, CacheSpecsMap cacheSpecsMap, RedisConnectionFactory connectionFactory) {
