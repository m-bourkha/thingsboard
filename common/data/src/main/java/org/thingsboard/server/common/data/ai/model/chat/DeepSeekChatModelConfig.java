...
@Schema
@Builder
public record DeepSeekChatModelConfig(
        @Schema(ref = "#/components/schemas/DeepSeekProviderConfig")
        @NotNull @Valid DeepSeekProviderConfig providerConfig,
...
) implements AiChatModelConfig<DeepSeekChatModelConfig> {
